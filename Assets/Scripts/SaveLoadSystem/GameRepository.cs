...
public sealed class GameRepository : IGameRepository
{
    ...
    public void LoadState()
    {
        if (PlayerPrefs.HasKey(GAME_STATE_KEY))
        {
            ...
            this.gameState = JsonConvert.DeserializeObject<Dictionary<string, string>>(Crypter.Decrypt(serializedState));
        }
        else
        {
    ...
    public void SaveState()
    {
        ...
        PlayerPrefs.SetString(GAME_STATE_KEY, Crypter.Encrypt(serializedState));
    }
